...
const VERSION = "arcade-v16";
const GAMES = ["zigdash", "merge", "snake", "mines", "bricks", "sudoku", "solitaire", "roll", "tubes", "flow", "stack", "hextris", "blocks", "splatz", "tower", "front", "doodle", "boom", "fleet", "snakes", "party", "pong", "sketch"];
const SHELL = ["./", "./hub.css", "./hub.js", "./config.js", "./rating.js", "./play.html", "./catalog.json", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png"];
