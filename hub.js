(() => {
  ...
  const BUILTIN = [
    ...
    { slug: "q1k3", title: "Q1K3", kind: "solo", url: "guest/q1k3/", icon: "guest/q1k3/icon-192.png", pc: true, by: "Dominic Szablewski" },
    { slug: "underrun", title: "UNDERRUN", kind: "solo", url: "guest/underrun/", icon: "guest/underrun/icon-192.png", pc: true, by: "Dominic Szablewski" },
    { slug: "packabunchas", title: "PACKABUNCHAS", kind: "solo", url: "guest/packabunchas/", icon: "guest/packabunchas/icon-192.png", by: "Rémi Vansteelandt" },
    { slug: "pathtoglory", title: "PATH TO GLORY", kind: "solo", url: "guest/pathtoglory/", icon: "guest/pathtoglory/icon-192.png", pc: true, by: "Rémi Vansteelandt" },
    { slug: "666", title: "666", kind: "solo", url: "guest/666/", icon: "guest/666/icon-192.png", pc: true, by: "js13kGames" },
    { slug: "space", title: "SPACE", kind: "solo", url: "guest/space/", icon: "guest/space/icon-192.png", pc: true, by: "Matthew Diamant" },
    { slug: "deathrun", title: "Careless Platformer", kind: "solo", url: "guest/deathrun/", icon: "guest/deathrun/icon-192.png", pc: true, by: "Adam Williams" },
  ];
