(() => {
  ...
  const BUILTIN = [
    ...
    { slug: "hextris", title: "Hextris", kind: "solo", url: "hextris/", icon: "hextris/icon-192.png", cat: "puzzle", by: "Hextris team", desc: "Rotate the hexagon, match three colors on a side. Keys or tap left/right." },
    { slug: "blocks", title: "Blocks", kind: "solo", url: "blocks/", icon: "blocks/icon-192.png", cat: "puzzle", pc: true, by: "Jake Gordon", desc: "Falling blocks classic. Arrows to move, up to rotate, space to drop." },
