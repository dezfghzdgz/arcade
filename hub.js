(() => {
  ...
  const T = {
    en: { sub: "Quick games. Solo or with friends over one link.", solo: "SOLO", friends: "WITH FRIENDS", community: "From the community", signIn: "Sign in", signUp: "Create account", signOut: "Sign out",
      ...
      pcOnly: "PC ONLY", pcLocked: "Needs a mouse – open on a PC", addHint: "Send us your HTML5 game. If it fits, it shows up here with your name.", zigdash: "Tap, flip, dodge. One thumb, leaderboard, daily missions.", splatz: "Paint arena for up to 8. Share a code, fill the rest with bots. 5 modes.", tower: "Race up the tower. Jump, springs, gears, lava. First to the top wins.", front: "Territory strategy. Draw the map together, spawn, expand, conquer 60%.", doodle: "Write it, draw it, guess it – telephone game for 2–10 friends, then laugh at the albums.", merge: "Slide and merge numbers. Daily challenge, undo, global leaderboard.", snake: "The classic, faster with every apple. Wrap-around or walls mode, bonus stars.", mines: "Minesweeper with a daily board and best-time leaderboard. Hold to flag.", checkEmail: "Check your e-mail to confirm the account, then sign in." },
    cs: { sub: "Rychlé hry. Sólo nebo s kamarády přes jeden odkaz.", solo: "SÓLO", friends: "S KAMARÁDY", community: "Od komunity", signIn: "Přihlásit", signUp: "Založit účet", signOut: "Odhlásit",
      ...
      pcOnly: "JEN PC", pcLocked: "Potřebuje myš – otevři na počítači", addHint: "Pošli nám svou HTML5 hru. Když sedne, objeví se tady s tvým jménem.", zigdash: "Ťukni, otoč se, uhni. Jeden palec, žebříček, denní úkoly.", splatz: "Malovací aréna až pro 8. Pošli kód, zbytek doplní boti. 5 módů.", tower: "Závod nahoru věží. Skoky, pružiny, ozubená kola, láva.", front: "Strategie o území. Nakreslete mapu, naspawnujte se, dobyjte 60 %.", doodle: "Napiš, nakresli, uhodni – tichá pošta pro 2–10 kamarádů, na konci alba k popukání.", merge: "Posouvej a spojuj čísla. Denní výzva, zpět, globální žebříček.", snake: "Klasika, s každým jablkem rychlejší. Průchozí okraje nebo stěny, bonusové hvězdy.", mines: "Miny s denním polem a žebříčkem nejlepších časů. Podržením vlajka.", checkEmail: "Potvrď účet v e-mailu a pak se přihlas." },
  };
