(() => {
  ...
  const T = {
    ...
    cs: { sub: "Rychlé hry. Sólo nebo s kamarády přes jeden odkaz.", solo: "SÓLO", friends: "S KAMARÁDY", community: "Od komunity", signIn: "Přihlásit", signUp: "Založit účet", signOut: "Odhlásit",
      ...
      installT: "Nainstaluj Arcade", installD: "funguje offline – sólo hry nepotřebují wifi", installBtn: "Nainstalovat", offlineBtn: "Uložit hry pro offline", offlineDone: "Uloženo – sólo hry teď jedou i bez internetu", iosHint: "Na iPhonu: Sdílet → Přidat na plochu", pcOnly: "JEN PC", pcLocked: "Potřebuje myš – otevři na počítači", addHint: "Pošli nám svou HTML5 hru. Když sedne, objeví se tady s tvým jménem.", zigdash: "Ťukni, otoč se, uhni. Jeden palec, žebříček, denní úkoly.", splatz: "Malovací aréna až pro 8. Pošli kód, zbytek doplní boti. 5 módů.", tower: "Závod nahoru věží. Skoky, pružiny, ozubená kola, láva.", front: "Strategie o území. Nakreslete mapu, naspawnujte se, dobyjte 60 %.", boom: "Horký brambor až pro 8. Bombu předáš dotykem, dashem utečeš. Komu bouchne v ruce, vypadává.", doodle: "Napiš, nakresli, uhodni – tichá pošta pro 2–10 kamarádů, na konci alba k popukání.", merge: "Posouvej a spojuj čísla. Denní výzva, zpět, globální žebříček.", snake: "Klasika, s každým jablkem rychlejší. Průchozí okraje nebo stěny, bonusové hvězdy.", mines: "Miny s denním polem a žebříčkem nejlepších časů. Podržením vlajka.", bricks: "Breakout s power-upy: multiball, laser, širší pálka, život navíc. Nekonečné levely.", sudoku: "Tři obtížnosti, poznámky, nápověda, kontrola chyb, denní sudoku se žebříčkem časů.", checkEmail: "Potvrď účet v e-mailu a pak se přihlas." },
  };
  ...
  if (navigator.serviceWorker) navigator.serviceWorker.addEventListener("message", (e) => { if (e.data === "precached") { toast(L("offlineDone"), 4000); $("btn-offline").disabled = false; } });
  applyLang();
})();
