window.I18N = {
  cs: {
    tagline: "Hadi proti sobě. Jez, rosť, nenaraz.", yourName: "Tvoje jméno",
    ...
    hintMobile: "Táhni prstem = směr · drž BOOST = zrychlení (ubírá délku)", hintPc: "WASD / šipky = směr · drž mezerník = boost (ubírá délku)",
    stats: (g, w, b) => `Her ${g} · výher ${w} · nejvíc ${b} %`, shareRoom: (c) => `Pojď hrát Snakes! Kód: ${c} `,
    ...
    modes: { arena: "Aréna", last: "Poslední", teams: "Týmy" },
    modeDesc: { arena: "Jídlo = bod, náraz soupeře do tebe = 3 body. Po smrti se vracíš.", last: "Bez návratu. Poslední živý vyhrává.", teams: "Dva týmy, bez návratu. Přežije tým." },
    ...
    ko: (a, b) => `${b} naboural do ${a}`, capture: (n) => `${n} +1`, teamA: "Tým Korál", teamB: "Tým Akva", teamWin: (t) => `${t} vyhrává!`,
  ...
  en: {
    tagline: "Snakes vs snakes. Eat, grow, don't crash.", yourName: "Your name",
    ...
    hintMobile: "Drag = direction · hold BOOST = speed (costs length)", hintPc: "WASD / arrows = direction · hold space = boost (costs length)",
    stats: (g, w, b) => `Games ${g} · wins ${w} · best ${b}%`, shareRoom: (c) => `Come play Snakes! Code: ${c} `,
    ...
    modes: { arena: "Arena", last: "Last one", teams: "Teams" },
    modeDesc: { arena: "Food = 1 pt, a rival crashing into you = 3 pts. Respawn after death.", last: "No respawn. Last snake alive wins.", teams: "Two teams, no respawn. Surviving team wins." },
    ...
    ko: (a, b) => `${b} crashed into ${a}`, capture: (n) => `${n} +1`, teamA: "Team Coral", teamB: "Team Aqua", teamWin: (t) => `${t} wins!`,
