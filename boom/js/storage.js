window.Storage = (() => {
  ...
  try { const an = localStorage.getItem("arcade_name"); if (an && localStorage.getItem("arcade_name_used") !== an) { st.name = an.slice(0, 12); set("bm_name", st.name); localStorage.setItem("arcade_name_used", an); } } catch {}
  return {
