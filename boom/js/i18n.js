window.I18N = {
  cs: {
    ...
    modes: { classic: "Klasika", chaos: "Chaos" }, out: (n) => `${n} vyletěl`, gotBomb: "MÁŠ BOMBU!", roundWin: (n) => `${n} vyhrál kolo`,
    modeDesc: { classic: "Jedna bomba. Dotykem ji předáš. Komu bouchne, vypadává. Poslední = 3 body, první na 6 vyhrává.", chaos: "Dvě bomby najednou." },
  ...
  en: {
    ...
    modes: { classic: "Classic", chaos: "Chaos" }, out: (n) => `${n} is out`, gotBomb: "YOU HAVE THE BOMB!", roundWin: (n) => `${n} wins the round`,
    modeDesc: { classic: "One bomb. Touch to pass it. Whoever holds it when it blows is out. Last one standing = 3 pts, first to 6 wins.", chaos: "Two bombs at once." },
