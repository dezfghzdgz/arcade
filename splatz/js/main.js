(() => {
  ...
  // ---------- solo / host: založení
  const BOT_NAMES = ["Bobek", "Zuzka", "Pepa", "Klára", "Rambo", "Kiki", "Tonda", "Máňa", "Rex", "Lili", "Bára", "Vašek"];
  ...
  function renderLobby() {
    ...
    seg("pu-btns", Object.keys(Sim.PU_RATE), lobby.opts.pu, (v) => Lang.pu(v), (v) => setOpt("pu", v));
