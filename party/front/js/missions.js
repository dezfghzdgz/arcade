...
window.Missions = (() => {
  ...
  const TYPES = {
    ...
    best:     { mode: "max", d: [[20, 40], [35, 70], [50, 120]],   w: [[60, 250], [70, 400]] },
    attacks:  { mode: "add", d: [[20, 30], [40, 50], [80, 90]],    w: [[300, 150], [600, 260]] },
  ...
  function afterGame(res, stats) {
    ...
    event("best", res.pct);
    if (stats.attacks) event("attacks", stats.attacks);
  }
