window.I18N = {
  cs: {
    tagline: "Pong 1v1 nebo 2v2. První na 7.", yourName: "Tvoje jméno",
    ...
    hintMobile: "Táhni prstem doleva/doprava = pálka", hintPc: "A/D nebo šipky = pálka",
    stats: (g, w, b) => `Her ${g} · výher ${w} · nejvíc ${b} %`, shareRoom: (c) => `Pojď hrát Pong! Kód: ${c} `,
    ...
    modes: { classic: "Klasika", speed: "Rychlý", multi: "Dva míčky" }, goalFor: (t) => `Bod: ${t}`,
    modeDesc: { classic: "Dole vs nahoře, první na 7. Míček s každým odrazem zrychlí. Ve 4 hráčích má každý půlku.", speed: "Rychlejší míček od začátku.", multi: "Dva míčky najednou." },
  ...
  en: {
    tagline: "Pong 1v1 or 2v2. First to 7.", yourName: "Your name",
    ...
    hintMobile: "Drag left/right = paddle", hintPc: "A/D or arrows = paddle",
    stats: (g, w, b) => `Games ${g} · wins ${w} · best ${b}%`, shareRoom: (c) => `Come play Pong! Code: ${c} `,
    ...
    modes: { classic: "Classic", speed: "Fast", multi: "Two balls" }, goalFor: (t) => `Point: ${t}`,
    modeDesc: { classic: "Bottom vs top, first to 7. Ball speeds up with each hit. With 4 players each guards half.", speed: "Faster ball from the start.", multi: "Two balls at once." },
