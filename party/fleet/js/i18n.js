window.I18N = {
  cs: {
    tagline: "Námořní bitva. Bokem k nepříteli a pal!", yourName: "Tvoje jméno",
    ...
    hintMobile: "Táhni prstem = kormidlo · tlačítko = salva z obou boků", hintPc: "WASD / šipky = kormidlo · mezerník = salva z obou boků",
    stats: (g, w, b) => `Her ${g} · výher ${w} · nejvíc ${b} %`, shareRoom: (c) => `Pojď hrát Fleet! Kód: ${c} `,
    ...
    modes: { deathmatch: "Bitva", teams: "Flotily", koth: "Král moří", treasure: "Poklad" },
    modeDesc: { deathmatch: "Nejvíc potopených lodí. 3 zásahy = ke dnu, návrat za 3 s.", teams: "Dvě flotily, součet potopení.", koth: "Drž zónu sám a sbírej sekundy. Zóna se stěhuje.", treasure: "Sbírej truhly. Potopená loď půlku truhel vysype." },
    ...
    ko: (a, b) => `${a} potopil ${b}`, capture: (n) => `${n} +1`, teamA: "Tým Korál", teamB: "Tým Akva", teamWin: (t) => `${t} vyhrává!`,
  ...
  en: {
    tagline: "Naval battle. Broadside and fire!", yourName: "Your name",
    ...
    hintMobile: "Drag = steer · button = broadside", hintPc: "WASD / arrows = steer · space = broadside",
    stats: (g, w, b) => `Games ${g} · wins ${w} · best ${b}%`, shareRoom: (c) => `Come play Fleet! Code: ${c} `,
    ...
    modes: { deathmatch: "Battle", teams: "Fleets", koth: "King of the sea", treasure: "Treasure" },
    modeDesc: { deathmatch: "Most ships sunk. 3 hits = down, back in 3 s.", teams: "Two fleets, sinks add up.", koth: "Hold the zone alone to collect seconds. The zone moves.", treasure: "Collect chests. A sunk ship drops half of them." },
