window.I18N = {
  cs: {
    tagline: "Skoč nahoru věží. První na vrcholu vyhrává.", yourName: "Tvoje jméno",
    ...
    hintMobile: "◀ ▶ = pohyb · JUMP = skok (drž = výš)", hintPc: "A/D nebo šipky = pohyb · mezerník = skok (drž = výš)",
    stats: (g, w, b) => `Her ${g} · výher ${w} · nejvýš ${b}. patro`, shareRoom: (c) => `Pojď hrát Tower! Kód: ${c} `, checkpoint: "Checkpoint!", out: (n) => `${n} v lávě`, finished: (n, r) => `${n} – ${r}. na vrcholu!`, lastCall: "Prvnímu se to povedlo – zbývá 20 s!",
    ...
    modes: { race: "Závod", lava: "Láva", endless: "Nekonečno", coins: "Mince" }, heights: { short: "krátká", medium: "střední", long: "dlouhá" }, watching: "Sleduješ", hostCantLeave: "Hostitel nemůže odejít – kolo by skončilo všem",
    modeDesc: { race: "Kdo první vyleze na vrchol. Po prvním v cíli zbývá 20 s.", lava: "Zespodu stoupá láva a zrychluje. Poslední přeživší vyhrává.", endless: "60 sekund, kdo vyleze nejvýš.", coins: "90 sekund, kdo posbírá nejvíc mincí na plošinách." },
    ...
    mission: { games: (n) => `Odehraj ${n} her`, wins: (n) => `Vyhraj ${n}×`, floors: (n) => `Vylez celkem ${n} pater`, best: (n) => `Dostaň se do ${n}. patra v jedné hře`, finishes: (n) => `Dolez na vrchol ${n}×`, jumps: (n) => `Skoč ${n}×`, top3: (n) => `Skonči ${n}× v top 3` },
    ability: { speed: "Rychlost!", shield: "Štít!", giant: "Obr!", gun: "Zbraň – 3 rány", freeze: "Zmrazeno!", frenzy: "Nekonečný dash! 3 s" },
  ...
  en: {
    tagline: "Jump up the tower. First to the top wins.", yourName: "Your name",
    ...
    hintMobile: "◀ ▶ = move · JUMP = jump (hold = higher)", hintPc: "A/D or arrows = move · space = jump (hold = higher)",
    stats: (g, w, b) => `Games ${g} · wins ${w} · best floor ${b}`, shareRoom: (c) => `Come play Tower! Code: ${c} `, checkpoint: "Checkpoint!", out: (n) => `${n} in the lava`, finished: (n, r) => `${n} – #${r} at the top!`, lastCall: "First one made it – 20 s left!",
    ...
    modes: { race: "Race", lava: "Lava", endless: "Endless", coins: "Coins" }, heights: { short: "short", medium: "medium", long: "long" }, watching: "Watching", hostCantLeave: "Host can't leave – it would end the round for everyone",
    modeDesc: { race: "First to the top wins. 20 s left after the first finisher.", lava: "Lava rises and speeds up. Last one standing wins.", endless: "60 seconds, highest climber wins.", coins: "90 seconds, most coins collected from platforms wins." },
    ...
    mission: { games: (n) => `Play ${n} games`, wins: (n) => `Win ${n} times`, floors: (n) => `Climb ${n} floors in total`, best: (n) => `Reach floor ${n} in one game`, finishes: (n) => `Reach the top ${n} times`, jumps: (n) => `Jump ${n} times`, top3: (n) => `Finish top 3 ${n} times` },
    ability: { speed: "Speed!", shield: "Shield!", giant: "Giant!", gun: "Gun – 3 shots", freeze: "Frozen!", frenzy: "Unlimited dash! 3 s" },
...
window.Lang = (() => {
  ...
  L.height = (k) => (I18N[lang].heights || I18N.en.heights)[k] || k;
  L.current = () => lang;
