window.Storage = (() => {
  ...
  try { const an = localStorage.getItem("arcade_name"); if (an && localStorage.getItem("arcade_name_used_tower") !== an) { st.name = an.slice(0, 12); set("tw_name", st.name); localStorage.setItem("arcade_name_used_tower", an); } } catch {}
  return {
