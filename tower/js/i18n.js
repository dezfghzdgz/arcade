window.I18N = {
  cs: {
    ...
    modes: { race: "Závod", lava: "Láva" }, heights: { short: "krátká", medium: "střední", long: "dlouhá" },
    modeDesc: { race: "Kdo první vyleze na vrchol. Po prvním v cíli zbývá 20 s.", lava: "Zespodu stoupá láva. Poslední přeživší vyhrává." },
  ...
  en: {
    ...
    modes: { race: "Race", lava: "Lava" }, heights: { short: "short", medium: "medium", long: "long" },
    modeDesc: { race: "First to the top wins. 20 s left after the first finisher.", lava: "Lava rises from below. Last one standing wins." },
